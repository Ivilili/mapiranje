let points = {
	...
	features: [
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.6674, 45.546134 ]
			},
			properties: {
				građevina: 'Filipovica-Hermanov vinograd',
				oznaka: 'Z-4960',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.635867, 45.558322 ]
			},
			properties: {
				građevina: 'Frigis 2',
				oznaka: 'Z-6947',
				...
				'UNESCO zaštita:': 'ne',
				'Opis dobra':
					'Arheološki lokalitet „Frigis 2“ u Osijeku pronađen je arheološkim terenskim pregledom trase južne obilaznice grada Osijeka, a nalazi se južno od osječkog prigradskog naselja Višnjevac na istaknutom ovalnom uzvišenju u meandru nekadašnjeg manjeg vodotoka. Probnim i zaštitnim istraživanjima pronađen je rub manjeg antičkog naselja vicus i fragmenti srednjovjekovne keramike. Na temelju pronađenih ulomaka keramike maslinasto zelene glazure koja se datira od 3. stoljeća pa do kraja antike možemo pretpostaviti da se ovdje nalazilo manje antičko naselje koje je egzistiralo na prostoru između Murse i Murselle prije i nakon provale Gota.'
			}
		},
		{
			type: 'Feature',
			geometry: {
				type: 'Point',
				coordinates: [ 18.670719, 45.55331 ]
			},
			properties: {
				građevina: 'Groblje sv. Ane',
				oznaka: 'Z-5843',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.681172, 45.554352 ]
			},
			properties: {
				građevina: 'Guttmannova stanica',
				oznaka: 'Z-2331',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.678938, 45.561337 ]
			},
			properties: {
				građevina: 'Hotel Royal',
				oznaka: 'Z-3448',
				'Vrijeme nastanka': '1904. god. do 1905. god.',
				Autori: 'Ivan Edvard Domes',
				adresa: 'Kapucinska 34',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.6765, 45.560024 ]
			},
			properties: {
				građevina: 'Hrvatsko narodno kazalište',
				oznaka: 'Z-1265',
				'Vrijeme nastanka': '1886. god.',
				Autori: 'Karlo Klauser',
				adresa: 'Županijska 9',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.694705, 45.561098 ]
			},
			properties: {
				građevina: 'Isusovački samostan',
				oznaka: 'Z-1666',
				'Vrijeme nastanka': '1719. god.',
				Autori: '',
				adresa: 'Križanićev trg 1',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'sakralna graditeljska baština',
				'UNESCO zaštita:': 'ne',
				'Opis dobra':
					'Isusovački samostan, izgrađen 1719.g, izduženog je pravokutnog oblika. Dvorišno pročelje razvedeno je nejednakim rizaltnim istacima (izvorno trima simetrično raspoređenim rizalitima) što je rezultat naknadnih intervencija tokom 18.st. kada se slobodnostojećoj građevini, uz istočno pročelje, prigrađuje stambena jednokatnica. Ulaz polukružnog lučnog zaključka flankiraju pilastri od kamena pješčenjaka koji nose prekinutu lunetu. Na zaglavnom kamenu, na tjemenu luka iznad ulaza, uklesana je godina izgradnje samostana–1719. U unutrašnjosti prostorije su smještene uz južno a hodnici uz dvorišno pročelje. Hodnici su presvođeni križno-bačvastim svodovima, a prostorije drvenim grednicima.'
			}
		},
		{
			type: 'Feature',
			geometry: {
				type: 'Point',
				coordinates: [ 18.697642, 45.559497 ]
			},
			properties: {
				građevina: 'Judenkaserne',
				oznaka: 'Z-1257',
				'Vrijeme nastanka': '18. st.',
				Autori: '-',
				adresa: 'Kamila Firingera 1',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
				'UNESCO zaštita:': 'ne',
				'Opis dobra':
					'Jednokatna, slobodno stojeća dvokrilna građevina, L tlocrtnog oblika, jedna od niza vojarni izgrađenih u prvoj polovici 18. st., smještenih na obodu Tvrđe u Osijeku. Dimenzije građevine, obrada i tretman pročelja, izrazitih su baroknih stilskih karakteristika. Komunikacija među etažama ostvarena je jednokrakim stubištima koja se nalaze na krajevima krila i u središtu, na mjestu spajanja dvaju krila. U prizemlju dužeg krila hodnik se proteže čitavom dužinom uz južno pročelje, a prostorije se nižu uz sjeverno. Sve prostorije kata imaju ravni drveni grednik. Iznad potkrovnog vijenca konkavnog oblika koji zaključuje pročelja građevine, uzdiže se četveroslivni krov koji prati tlocrtni oblik. Danas je u toj zgradi smješten Državni arhiv.'
			}
		},
		{
			type: 'Feature',
			geometry: {
				type: 'Point',
				coordinates: [ 18.670236, 45.564071 ]
			},
			properties: {
				građevina: 'Kapela sv. Roka',
				oznaka: 'Z-1661',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.716513, 45.558911 ]
			},
			properties: {
				građevina: 'Kapela sv. Roka',
				oznaka: 'Z-1261',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.680398, 45.56173 ]
			},
			properties: {
				građevina: 'Kino Korzo, danas kino Europa',
				oznaka: 'Z-5759',
				'Vrijeme nastanka': '1940. god.',
				Autori: 'Ljudevit Pelzer',
				adresa: 'Šetalište Petra Preradovića 2',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.682634, 45.561551 ]
			},
			properties: {
				građevina: 'Kino Urania',
				oznaka: 'Z-5760\n\n',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.695795, 45.559307 ]
			},
			properties: {
				građevina: 'Konjička vojarna',
				oznaka: 'Z-5856',
				'Vrijeme nastanka': '1721. god.',
				Autori: '',
				adresa: 'Firingerova 3',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.680664, 45.558144 ]
			},
			properties: {
				građevina: 'Kuća Berger',
				oznaka: 'Z-6099',
				'Vrijeme nastanka': '1895. god.',
				Autori: '',
				adresa: 'Ulica Hrvatske republike 9',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.690431, 45.556371 ]
			},
			properties: {
				građevina: 'Kuća Helfrich',
				oznaka: 'Z-5889',
				'Vrijeme nastanka': '1939. god. do 1941. god.',
				Autori: 'Ljudevit Pelzer',
				adresa: 'Keršovanijeva 10a',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.716222, 45.558972 ]
			},
			properties: {
				građevina: 'Kuća Kragujević (Mitrović)',
				oznaka: 'Z-1262',
				'Vrijeme nastanka': '1760. god.',
				Autori: '',
				adresa: 'Gojkovićeva 1',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
				'UNESCO zaštita:': 'ne',
				'Opis dobra':
					'Kuća Kragujević, izgrađena oko 1760. g., slobodnostojeća je prizemnica, tlocrtne osnove u obliku izduženog pravokutnika. Iz tlocrtnog rješenja vidljivi su sastavni elementi građevine čiji prostor je dvonamjenski organiziran – za stanovanje i obrt. Kuća ima stilske karakteristike gradnje iz doba baroka. Osebujnost njene arhitekture čini slikovito oblikovanje pročelja s natkrivenim lučno otvorenim trijemom čije segmentne lukove nose valjkasti stubovi između kojih prostor popunjava transparentna, od željeza kovana, ograda'
			}
		},
		{
			type: 'Feature',
			geometry: {
				type: 'Point',
				coordinates: [ 18.690491, 45.556512 ]
			},
			properties: {
				građevina: 'Kuća Mandić',
				oznaka: 'Z-5823',
				'Vrijeme nastanka': '1940. god.',
				Autori: 'Ljudevit Pelzer',
				adresa: 'Keršovanijeva 10',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.71649, 45.556284 ]
			},
			properties: {
				građevina: 'Kuća Wlaszak',
				oznaka: 'Z-7014',
				'Vrijeme nastanka': '1906. god.',
				Autori: 'Ante Slaviček',
				adresa: 'Trg bana Jelačića 3',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.695118, 45.560286 ]
			},
			properties: {
				građevina: 'Kužni pil',
				oznaka: 'Z-1665',
				'Vrijeme nastanka': '1729.-1730.g',
				Autori: '',
				adresa: 'Trg Presvetog Trojstva',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.652288, 45.566188 ]
			},
			properties: {
				građevina: 'Mađarska Retfala',
				oznaka: 'Z-5500',
				'Vrijeme nastanka': '5300 st.p.n.e. do 12. st.',
				Autori: '-',
				adresa: 'zapadni dio grada',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'arheološka baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.660188, 45.563047 ]
			},
			properties: {
				građevina: 'Mauzolej Pejačević',
				oznaka: 'Z-2324',
				...
				'UNESCO zaštita:': 'ne',
				'Opis dobra':
					'Mauzolej plemičke obitelji Pejačević izgrađen je 1891. godine jugozapadno od dvorca Pejačević na Retfalačkom groblju. Temeljne značajke ove raritetne memorijalne građevine su elipsoidni tlocrt, mansardni krov s kupolom i bogata obrada interijera. Mauzolej obitelji Pejačević ima nacionalni značaj jer predstavlja izuzetno umjetničko, arhitektonsko i graditeljsko djelo koje pripada značajnom razdoblju nacionalne povijest'
			}
		},
		{
			type: 'Feature',
			geometry: {
				type: 'Point',
				coordinates: [ 18.676801, 45.551848 ]
			},
			properties: {
				građevina: 'Niz radničkih kuća tvornice Povischil',
				oznaka: 'Z-6126',
				'Vrijeme nastanka': '20. st.',
				Autori: '',
				adresa: 'Jadranska ulica 2, 3, 4, 5, 6, 7 i 8',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.69716, 45.561717 ]
			},
			properties: {
				građevina: 'Novi samostan sv. Križa',
				oznaka: 'Z-1663',
				'Vrijeme nastanka': '1705. god. do 1732. god.',
				Autori: '',
				adresa: 'Bosendorferova 2',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'sakralna graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.684957, 45.560292 ]
			},
			properties: {
				građevina: 'Palača kraljevskog sudbenog stola',
				oznaka: 'Z-2335',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.663768, 45.557048 ]
			},
			properties: {
				građevina: 'Petruš II',
				oznaka: 'Z-7170',
				...
				'UNESCO zaštita:': 'ne',
				'Opis dobra':
					'Lokalitet se nalazi južno od osječkog prigradskog naselja Višnjevac na istaknutom ovalnom uzvišenju u meandru nekadašnjeg manjeg vodotoka. Pri formiranju prostora na kojem s nalazi lokalitet najveću je ulogu imala rijeka Drava koja svojim plavljenjem formira naplavne (aluvijalne) ravni. Tijekom terenskog pregleda prikupljeni prapovijesni, antički i srednjovjekovni arheološki materijal upućivao je na intenzivnu naseljavanost tijekom sva tri vremenska razdoblja.'
			}
		},
		{
			type: 'Feature',
			geometry: {
				type: 'Point',
				coordinates: [ 18.648718, 45.568092 ]
			},
			properties: {
				građevina: 'Reformirana kršćanska crkva',
				oznaka: 'Z-1266',
				'Vrijeme nastanka': '1823. god.',
				Autori: '',
				adresa: 'Š. Petefija 78',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'sakralna graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.694175, 45.560582 ]
			},
			properties: {
				građevina: 'Rodna kuća Franje Kuhača',
				oznaka: 'Z-1256',
				...
				'UNESCO zaštita:': 'ne',
				'Opis dobra':
					'Rodna kuća muzikologa F. Kuhača, jednokatnica je L tlocrta, izgrađena početkom 18., tijekom 19. stoljeća vršene su brojne izmjene oblika. Njezino glavno krilo ugrađeno je u gusti ulični niz glavne tvrđavske ulice, a dvorišno je prislonjeno uz istočnu granicu parcele. Njezino glavno ulično pročelje stroge je simetrične koncepcije sa elementima mješavine baroknih i historicističkih arhitektonsko stilskih odlika. Iznad ulaza, flankiranog pilastrima koji nose profilirani nadvratnik nalaze se dvije bogato dekorirane konzole koje nose balkon sa ogradom od kovanog željeza.'
			}
		},
		{
			type: 'Feature',
			geometry: {
				type: 'Point',
				coordinates: [ 18.683913, 45.562165 ]
			},
			properties: {
				građevina: 'Secesijski zdenac',
				oznaka: '',
				'Vrijeme nastanka': '1903. god.',
				Autori: '',
				adresa: 'Šetalište kardinala Šepera',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.684733, 45.556309 ]
			},
			properties: {
				građevina: 'Silos Union paromlina',
				oznaka: 'Z-5896',
				'Vrijeme nastanka': '1891. god.',
				Autori: 'Bruno Bauer ; Viktor Beneš',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.688507, 45.558557 ]
			},
			properties: {
				građevina: 'Sokolski dom',
				oznaka: 'Z-2326',
				...
				'UNESCO zaštita:': 'ne',
				'Opis dobra':
					'Zgrada Sokolane izgrađena je po projektima arhitekta Viktora Axmanna 1927. godine. Slobodnostojeća zgrada ima pravokutnu tlocrtnu osnovu. Pročelje je obrađeno u duhu novog klasicizma. Ulaz je koncipiran kao fronta grčkog hrama. Historicistička fasada s pilastrima nosi krovni vijenac na kome je visoki mansardni krov. Zgrada sadrži veliku dvoranu i pomoćne prostorije. U zadnjem dijelu nalaze se garderobe, tuševi i spremišta. Građena u duhu novog historicizma zgrada Sokolane po urbanističkoj dispoziciji, veličini i povijesnom značaju predstavlja vrijedno kulturno dobro specifične namjene u kojoj se konstruktivna sredstva podređuju prostorno-estetskoj ideji.'
			}
		},
		{
			type: 'Feature',
			geometry: {
				type: 'Point',
				coordinates: [ 18.660181, 45.563036 ]
			},
			properties: {
				građevina: 'Spomenički kompleks Dvorca Pejačević',
				oznaka: 'Z-3045',
				'Vrijeme nastanka': '1801. god.',
				Autori: '',
				adresa: 'Strossmayerova 141',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.693711, 45.558423 ]
			},
			properties: {
				građevina: 'Spomenik palim vojnicima Šokčevićeve pukovnije ("Umirući vojnik")',
				oznaka: 'Z-3871',
				'Vrijeme nastanka': '1897. g.',
				Autori: 'Robert Frangeš-Mihanović',
				adresa: 'Park kralja Držislava',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'memorijalna baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.679471, 45.545971 ]
			},
			properties: {
				građevina: 'Stambena vila Mačkamama',
				oznaka: 'Z-3342',
				'Vrijeme nastanka': '20. st.',
				Autori: '',
				adresa: 'Drinska 2',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.696356, 45.560407 ]
			},
			properties: {
				građevina: 'Trgovačka kuća',
				oznaka: 'Z-1258',
				'Vrijeme nastanka': '18. st. do 19. st.',
				Autori: '-',
				adresa: 'Trg sv. Trojstva 5',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
				'UNESCO zaštita:': 'ne',
				'Opis dobra':
					'Izgradnja Trgovačke kuće započela je u prvoj polovici 18. st., u 19. st., probijanjem zida na katu spojena je sa zgradom Magistrata. Danas je trokrilna jednokatnica, ali je taj izgled poprimila postepeno. Pretpostavlja se da je njezino zapadno krilo izgrađeno prije zgrade Magistrata, a istočno kasnije. Treće krilo koje se nalazi uz sjevernu među parcele nastaje postepeno brojnim prigradnjama. Prizemlje je obogaćeno kvadrima stilizirane rustike, a od zone kata odijeljano je razdijelnim vijencem dekoriranim meandrima. Visinska podjela pročelja ostvarena je kordonskim i završnim vijencem, a horizontalna u zoni kata pilastrima s impostima. Danas je tu smješten Muzej Slavonije.'
			}
		},
		{
			type: 'Feature',
			geometry: {
				type: 'Point',
				coordinates: [ 18.678108, 45.546083 ]
			},
			properties: {
				građevina: 'Tvornička zgrada tvornice Povischil',
				oznaka: 'Z-5781',
				'Vrijeme nastanka': '19. st.',
				Autori: '',
				adresa: 'Vinkovačka cesta',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
				'UNESCO zaštita:': 'ne',
				'Opis dobra':
					'Prva osječka tvornica za preradu drva Rudolfa Keisera, osnovana je 1865. godine. Tvornica Keiser izgrađena je na Čepinskoj cesti, (poslije na istoj lokaciji nastaje Obnova), te tvornica Povischil na lokaciji uz Vinkovačku cestu, kasnije tvornica Mobilia »Ivo Marinković« registrirana kao tvornica industrije drva s parnom pilanom, tvornica parketa, oruđa, stolarskog i tapetarskog, tokarskog te bravarskog alata, tvornica pokućstva i dr. Od cijelog kompleksa tvornice Povischil od tvorničkih zgrada danas je ostala sačuvana samo jedna zgrada skladišta. Postojeća tvornička zgrada smještena je uz Vinkovačku cestu na istočnoj obodnoj strani nekadašnjeg velikog tvorničkog kompleksa. Iako izgrađena za utilitarnu industrijsku namjenu, tvornička zgrada svojim artikuliranim pročeljem i dekorativnim elementima odlikuje se naznakama stilskih elemenata art decoa. Tvornička zgrada predstavlja jedinstven dokaz i svjedočanstvo razvoja drvne industrije u Osijeku.'
			}
		},
		{
			type: 'Feature',
			geometry: {
				type: 'Point',
				coordinates: [ 18.689173, 45.558027 ]
			},
			properties: {
				građevina: 'Učenički dom Hrvatskog radiše',
				oznaka: 'Z-2329',
				'Vrijeme nastanka': '1926. god.',
				Autori: 'Viktor Axmann',
				adresa: 'Zagrebačka 2a',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
				'UNESCO zaštita:': 'ne',
				'Opis dobra':
					'Zgrada Učeničkog Doma „Hrvatskog Radiše“ izgrađena je prema projektima osječkog arhitekta Viktora Axmanna 1926. godine. Slobodnostojeća jednokatnica simetrične tlocrtne dispozicije. Prva zgrada u Osijeku izgrađena kao suvremeno boravište za učenike Obrtne škole po funkcionalnoj koncepciji i obradi pročelja sadrži opće prihvaćene likovne i estetske vrijednosti vremena u kome je nastala i čini sastavni dio vrijednog ansambla osječke moderne nastale između 1920. i 1939. godine.'
			}
		},
		{
			type: 'Feature',
			geometry: {
				type: 'Point',
				coordinates: [ 18.670201, 45.562798 ]
			},
			properties: {
				građevina: 'Vatrogasni toranj',
				oznaka: 'Z-6734',
				'Vrijeme nastanka': '1916. god.',
				Autori: 'Axmann – Mallin – Rožić',
				adresa: 'Pejačevićeva 44',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'ostalo',
				'UNESCO zaštita:': 'ne',
				'Opis dobra':
					'Vatrogasni toranj u Pejačevićevoj ulici podignut je 1893. godine. Današnji izgled vatrogasni toranj je dobio dogradnjom 1916. godine prema projektu poznatih osječkih ovlaštenih arhitekata i graditelja Axmann – Mallin – Rožić. U tornju je bila smještena cisterna zapremine 60.000 litara. Toranj kvadarskog volumena zidan je opekom. Tlocrtna osnova tornja je 5,98 × 5,81 m, a ukupna visina 26,5 m. Posljednja i najviša etaža, nadogradnja iz 1916. godine, ukrašena je vertikalnim lezenama pri vrhu kojih se nalazi pet prozorskih otvora. Dvostrešno krovište pokriveno je eternit pločama. Na vrhu krova nalazi se otvor s osmokutnom osmatračnicom ograđenom metalnom kovanom ogradom. Unutrašnjošću tornja sve do vrha uzdižu se masivne stepenice od hrastovine.'
			}
		},
		{
			type: 'Feature',
			geometry: {
				type: 'Point',
				coordinates: [ 18.722157, 45.555144 ]
			},
			properties: {
				građevina: 'Vatrogasni toranj',
				oznaka: 'Z-7164',
				...
				'UNESCO zaštita:': 'ne',
				'Opis dobra':
					'Prvi vatrogasni toranj u Donjem gradu je podignut 1885. godine, a novi, do danas sačuvani, izgrađen je 1927. godine. Zidan je opekom, dok su sve međukatne konstrukcije izvedene u kombinaciji betonskih i drvenih greda. Tlocrtna osnova tornja je 6,23 × 5 m, a ukupna visina oko 29 m. Najviša etaža vatrogasnog tornja šira je od njegovog osnovnog volumena. Toranj je pri vrhu zabatno zaključen s istočne i zapadne strane. Dvostrešno krovište pokriveno je eternit pločama. Na vrhu krova nalazi se otvor s osmatračnicom ograđenom metalnom kovanom ogradom. Unutrašnjošću tornja sve do vrha uzdiže se masivno stubište od hrastovine. U prizemlju tornja s istočne, dvorišne strane, nalaze se dvokrilna vrata. S obje bočne strane tornja nalaze se garaže za vatrogasna vozila. Toranj, iako danas više nema uporabnu funkciju, predstavlja značajan orijentir i reper prepoznatljiv u prostoru osječkog Donjeg grada.'
			}
		},
		{
			type: 'Feature',
			geometry: {
				type: 'Point',
				coordinates: [ 18.690625, 45.557047 ]
			},
			properties: {
				građevina: 'Vila Hoffman',
				oznaka: 'Z-2468',
				'Vrijeme nastanka': '1935. god.',
				Autori: 'Viktor Axmann',
				adresa: 'Keršovanijeva 4',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.687527, 45.557921 ]
			},
			properties: {
				građevina: 'Vila Nikole Klira',
				oznaka: 'Z-2333',
				'Vrijeme nastanka': '1927. god.',
				Autori: 'Viktor Axmann',
				adresa: 'Franje Krežme 5',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.683359, 45.555115 ]
			},
			properties: {
				građevina: 'Vila ravnatelja "Union" paromlina',
				oznaka: 'Z-6272',
				'Vrijeme nastanka': '1906. god.',
				Autori: '',
				adresa: 'Radićeva 23',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.693686, 45.556838 ]
			},
			properties: {
				građevina: 'Vila Szinicz',
				oznaka: 'Z-5890',
				...
				'UNESCO zaštita:': 'ne',
				'Opis dobra':
					'Godine 1942. Hans Kiefer izradio je projekt za obiteljsku vilu Szinicz. Radove je izveo Franjo Dlouhy, ovlašteni graditelj, a građevinski nadzor je vršio ing. Bartol Rubinstein, obojica ugledni Osječani čija imena susrećemo na velikom broju gradnji toga vremena. Visoka poluugrađena jednokatnica, glavnim, uličnim pročeljem orijentirana je prema istoku, svojom južnom stranom ugrađena je u blok ulice, dok joj je sjeverna strana kompozicijski slobodna, s kolnim prolazom u veće dvorište na zapadnoj strani vile. S manjim odstupanjima od klasične tlocrtne simetrije, vila Szinicz oblikovana je kao kubus. Stambena katnica odlikuje se čistoćom stila. Pročelje čistih ploha i ravnih linija ima plitko aplicirane vijence koji stvaraju profinjeno oblikovane izdužene profilirane trake u kojima su smješteni prozori, te simbolički naglašeni krovni vijenac. Oslobođena svih suvišnih ukrasa odlikuje se jednostavnošću i jasnoćom volumena. Skladan estetski izgled postignut je ujednačenim odnosom prozora i zidnog plašta.\n'
			}
		},
		{
			type: 'Feature',
			geometry: {
				type: 'Point',
				coordinates: [ 18.719654, 45.558826 ]
			},
			properties: {
				građevina: 'Zgrada',
				oznaka: ' Z-3096',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.673721, 45.560978 ]
			},
			properties: {
				građevina: 'Zgrada',
				oznaka: 'Z-5520',
				'Vrijeme nastanka': 'Wilim Carl Hofbauer',
				Autori: '1901. god.',
				adresa: 'Pavla Pejačevića 9',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
				'UNESCO zaštita:': 'ne',
				'Opis dobra':
					'Kuća u Pejačevićevoj ulici 9 smještena je unutar stare jezgre Gornjeg grada Osijeka, u blizini Velike crkve. Obostrano je ugrađena, čineći dio uličnog niza prizemnica koji se proteže u smjeru istok-zapad. Izgradio ju je 1901. godine arhitekt Wilim Carl Hofbauer kao svoju obiteljsku kuću. Važnost nekoć privatne kuće arhitekta Wilima Carla Hofbauera nije samo u izvorno očuvanom rasteru prostorija koji očitava stremljenja secesijskog načina poimanja obiteljskog prostora s pratećom dekoracijom i njezinim promjenama već i u tome što zajedno s još njegovih desetak postojećih zgrada čini u potpunosti sačuvani opus gradnje jednog arhitekta koja kao takva pridonosi opstanku gradske jezgre arhitektonske ostavštine Osijeka, bivajući integralnim dijelom njegovog korpusa na prijelazu iz 19. u 20. stoljeće.'
			}
		},
		{
			type: 'Feature',
			geometry: {
				type: 'Point',
				coordinates: [ 18.677553, 45.561141 ]
			},
			properties: {
				građevina: 'Zgrada',
				oznaka: 'Z-3452',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.676176, 45.561473 ]
			},
			properties: {
				građevina: 'Zgrada',
				oznaka: 'Z-3451',
				...
				'UNESCO zaštita:': 'ne',
				'Opis dobra':
					'Jednokatna uglovnica izgrađena je za F. Thürnera u drugoj polovini 19. stoljeća na jugozapadnom uglu glavnog trga. U prizemlju je rastvorena otvorima dućana i izloga s ulaznom vežom na istočnom pročelju. Izvorni nacrti nisu pronađeni tako da nam i projektant ostaje nepoznat. Zgrada objašnjava urbarhitektonski razvoj trga i kao takva osim ambijentalne ima i povijesnu vrijednost jer je dio povijesnog kontinuiteta razvoja trga. Zgrada svojom namjenom koja je ostala ista od njezinog nastanka do danas pridonosi i trgovačkoj važnosti trga. Umjetnička vrijednost je u stilskom izrazu historicizma s primjesama maurskih dekorativnih elemenata s kojima se približava više romantičarskom historicizmu.'
			}
		},
		{
			type: 'Feature',
			geometry: {
				type: 'Point',
				coordinates: [ 18.676192, 45.561833 ]
			},
			properties: {
				građevina: 'Zgrada',
				oznaka: 'Z-3450',
				...
				'UNESCO zaštita:': 'ne',
				'Opis dobra':
					'Stambeno poslovna dvokatna zgrada dio je niza zgrada koje formiraju zapadnu stranu glavnog osječkog trga. Izgrađena je sredinom 19. stoljeća, nepravilanog tlocrtnog oblika slova U. Zidana je punom ciglom, pročelja su žbukana i bojana. Po stilskom određenju pripada arhitekturi historicizma s geometrijskim motivima i orijentalnim elemenatima koji karakteriziraju romantičarski zanos ranog historicizma što pridonosi umjetničkoj vrijednosti zgrade. Arhitektonsku vrijednost potvrđuje nepravilan tlocrt, rješenje dvorišnih pročelja s dugačkim balkonima postavljenih na konzole, raspored otvora na pročeljima, koncepcija unutrašnjeg prostora, prirodno osvjetljenje putem prozora i slično.'
			}
		},
		{
			type: 'Feature',
			...
			properties: {
				...
				'UNESCO zaštita:': 'ne',
				'Opis dobra':
					'Jednokatna zgrada izgrađena je na sjevernoj strani glavnog gradskog trga. Zgrada je građena u 18. stoljeću u duhu barokne arhitekture. Jedna od tri sačuvanih na trgu koje se razlikuju morfologijom. Svojim oblikom i dimenzijama predstavlja raritet i daje nam uvid o kulturnom životu Osijeka u 18. stoljeću. Ima nešto niže krovište što je karakteristično za barokne zgrade druge polovine 18. stoljeća, na kojima se već pomalo osjeća pojava historicizma. Zgrada je zadržala svoju baroknu osnovu, jedino je pročelje u 19. stoljeću dobilo nove aplikacije koje nisu degradirale baroknu koncepciju same zgrade.'
			}
		},
		{
			type: 'Feature',
			geometry: {
				type: 'Point',
				coordinates: [ 18.676607, 45.560798 ]
			},
			properties: {
				građevina: 'Zgrada',
				oznaka: 'Z-3455',
				'Vrijeme nastanka': 'Alois Flembach',
				Autori: '1860. god.',
				adresa: 'Županijska 1',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.676211, 45.55883 ]
			},
			properties: {
				građevina: 'Zgrada',
				oznaka: 'Z-3454',
				'Vrijeme nastanka': 'Richard Berner',
				Autori: '1906. god.',
				adresa: 'Županijska 15',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			properties: {
				...
				'UNESCO zaštita:': 'ne',
				'Opis dobra':
					'Jednokatna stambeno poslovna zgrada izgrađena je za Heinrich Füllera prema nacrtima Alois Flambacha iz 1866. godine. Ova zgrada zauzima važno mjesto iz razloga praćenja, njegovog opusa u Osijeku. Raspored prozora na pročelju, dekoracija, rizalitno istaknut središnji dio s kolnim ulazom daju zgradi reprezentativan izgled. Posebno je zanimljivo oblikovano pročelje dvorišta sa stupovima koji nose lukove i tvore trijem. Posebnu pažnju bi trebalo obratiti na detalje u oblikovanju unutrašnjeg prostora kao što je reprezentativno drveno stubište, mali volumen uz stubište čiju namjenu nagađamo, zatim na stepenice u bočnim krilima i dvorišno pročelje, te ih spriječiti od daljnjeg propadanja.'
			}
		},
		{
			type: 'Feature',
			geometry: {
				type: 'Point',
				coordinates: [ 18.675183, 45.555533 ]
			},
			properties: {
				građevina: 'Zgrada',
				oznaka: ' Z-3453',
				'Vrijeme nastanka': 'Ante Slaviček',
				Autori: '1903. god.',
				adresa: 'Županijska 38',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
				'UNESCO zaštita:': 'ne',
				'Opis dobra':
					'Stambeno poslovna katnica izgrađena 1903. godine svojom urbanističkom dispozicijom, veličinom i ljepotom nameće se ovom dijelu ulice kao tranzitne prometnice u 19. stoljeću. Projekt je naručio osječki trgovac Ivan Nossan kod uvaženog osječkog arhitekte Ante Slavičeka. U prizemlju su bile prostorije za dva lokala. Tlocrt prvog kata je nepravilnog pravokutnog oblika s polukružnim volumenom u kojem je stubište. Zgrada je izgrađena u duhu reprezentativne secesije s obiljem dekoracije na pročelju koja karakterizira stil arhitekta Slavičeka. U stilskom izrazu zgrada je rezultat arhitektonskog traženja na prijelazu 19. stoljeća u 20. stoljeće koje je tada bilo istovremeno s europskim težnjama.'
			}
		},
		{
			type: 'Feature',
			geometry: {
				type: 'Point',
				coordinates: [ 18.681046, 45.561592 ]
			},
			properties: {
				građevina: 'Zgrada "Granum"',
				oznaka: ' Z-2466',
				'Vrijeme nastanka': '1922. god.',
				Autori: 'Viktor Axmann',
				adresa: 'Šetalište P. Preradovića 5',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.69195, 45.555829 ]
			},
			properties: {
				građevina: 'Zgrada „ Dom HV-a“',
				oznaka: 'Z-7175',
				'Vrijeme nastanka': '1949. god.',
				Autori: '',
				adresa: 'D. Cesarića 1b',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
				'UNESCO zaštita:': 'ne',
				'Opis dobra':
					'Zgrada je izgrađena 1949. godine za potrebe Jugoslavenske Narodne Armije, kada je bila poznata pod nazivom Dom JNA. Danas je u zgradi smješteno Ministarstvo obrane RH, Oružane snage RH. Monumentalna, slobodnostojeća zgrada, projektirana je jasnim izrazom i čistoćom arhitektonskih formi uz uvažavanje pojedinih zakonitosti internacionalne moderne arhitekture. Urbanistički izvanredno komunicira sa svojom okolinom u smislu skladnog inkorporiranja moderne arhitekture unutar zadanog prostora, povijesno - arhitektonskog sklopa Tvrđe i ambijentalnog sklopa Parka projektiranog u stilu moderne kao i urbanih blokova moderne arhitekture.'
			}
		},
		{
			type: 'Feature',
			geometry: {
				type: 'Point',
				coordinates: [ 18.71602, 45.557119 ]
			},
			properties: {
				građevina: 'Zgrada Aksman',
				oznaka: 'Z-1658',
				'Vrijeme nastanka': 'drugoj polovici XVIII. st',
				Autori: '',
				adresa: 'Huttlerova 1',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.675779, 45.558707 ]
			},
			properties: {
				građevina: 'Zgrada Baumgartner',
				oznaka: 'Z-3784',
				...
				'UNESCO zaštita:': 'ne',
				'Opis dobra':
					'Uvaženi osječki arhitekt, Ante Slaviček, 1911. godine projektirao je i izgradio osebujnu jednokatnicu secesijskog stila za Alexandra Baumgärtnera, trgovca šivaćih i ostalih strojeva. Zgrada ima tlocrt u obliku nepravilnog slova U s dužim južnim krakom. U vrijeme izgradnje u prizemlju su bile prostorije za trgovačko – obrtničke potrebe, a kat je bio namijenjen stanovanju. Danas se u njoj nalazi kavana i hotel Waldinger. Zgrada je građena u duhu reprezentativne secesije s bogatom floralnom dekoracijom u štuku. Glavno pročelje odlikuje stilska reprezentativnost secesijskog stila s prepoznatljivim izrazom eminentnog osječkog arhitekte Ante Slavičeka.'
			}
		},
		{
			type: 'Feature',
			geometry: {
				type: 'Point',
				coordinates: [ 18.694688, 45.548153 ]
			},
			properties: {
				građevina: 'Zgrada bivše gostionice Gradskog vrta',
				oznaka: 'Z-1264',
				'Vrijeme nastanka': '19. st.',
				Autori: '',
				adresa: 'Divaltova 4',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.683344, 45.560573 ]
			},
			properties: {
				građevina: 'Zgrada bivšeg "Obrtničkog doma"',
				oznaka: 'Z-2470',
				'Vrijeme nastanka': '1896. god.',
				Autori: '',
				adresa: 'Europska avenija 11',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
				'UNESCO zaštita:': 'ne',
				'Opis dobra':
					'Slobodnostojeća jednokatnica pravilnog tlocrta, kvadratnog gabarita i zatvorene forme izgrađena je 1896. godine s unutrašnjim rasporedom prostorija koje u prizemlju prema ulici otvaraju veliku dvoranu. Zgrada svojom monumentalnošću i oblikovanjem je odlično uklopljena u ambijentalni niz velebnih stambenih zgrada s predvrtovima u centru grada, a njezin mirni, zatvoreni kubni volumen i neoklasicistički izraz daju posebno mjesto toj zgradi unutar gradske stambene arhitekture kraja 19. stoljeća u Osijeku.'
			}
		},
		{
			type: 'Feature',
			geometry: {
				type: 'Point',
				coordinates: [ 18.68065, 45.561598 ]
			},
			properties: {
				građevina: 'Zgrada Čačinović',
				oznaka: 'Z-3783',
				'Vrijeme nastanka': '1906. god',
				Autori: 'Viktor Axmann',
				adresa: 'Šetalište P. Preradovića 3',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.687146, 45.558763 ]
			},
			properties: {
				građevina: 'Zgrada Doma mirovinske zaklade',
				oznaka: 'Z-3101',
				'Vrijeme nastanka': '1932. god.',
				Autori: 'Aksmanović i Malin',
				adresa: 'Ulica kralja Zvonimira 11',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.680865, 45.558829 ]
			},
			properties: {
				građevina: 'Zgrada Filozofskog fakulteta',
				oznaka: 'Z-2332',
				'Vrijeme nastanka': 'Mauro Karlo Hinteräger',
				Autori: '1897. god.',
				adresa: 'Jägerova 9',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.680974, 45.560873 ]
			},
			properties: {
				građevina: 'Zgrada FINA-e',
				oznaka: 'Z-3390',
				'Vrijeme nastanka': 'Hugo Ehrlich',
				Autori: '1921. god.',
				adresa: 'Ulica Lorenza Jagera 1',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.683737, 45.560523 ]
			},
			properties: {
				građevina: 'Zgrada Galerije likovnih umjetnosti',
				oznaka: 'Z-2336',
				'Vrijeme nastanka': 'Josip pl. Vancaš',
				Autori: '1895. god.',
				adresa: 'Europska avenija 9',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.695926, 45.560997 ]
			},
			properties: {
				građevina: 'Zgrada Generalkomande',
				oznaka: 'Z-1254',
				'Vrijeme nastanka': '',
				Autori: '18. st.',
				adresa: 'Trg sv. Trojstva 3',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.682752, 45.561098 ]
			},
			properties: {
				građevina: 'Zgrada Gillming-Hengl',
				oznaka: 'Z-2343',
				'Vrijeme nastanka': 'Ernest von Gotthilf',
				Autori: '1906. god.',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.686078, 45.56015 ]
			},
			properties: {
				građevina: 'Zgrada Glavne pošte',
				oznaka: 'Z-1660',
				'Vrijeme nastanka': '',
				Autori: '1912. god.',
				adresa: '',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.695265, 45.560846 ]
			},
			properties: {
				građevina: 'Zgrada Glavne straže',
				oznaka: 'Z-1253',
				'Vrijeme nastanka': '',
				Autori: '18. st.',
				adresa: 'Trg sv. Trojstva 2',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.679313, 45.561052 ]
			},
			properties: {
				građevina: 'Zgrada Gradske štedionice',
				oznaka: 'Z-3782',
				'Vrijeme nastanka': 'Ivan Domes; Alfred Albini',
				Autori: '1930. god.',
				adresa: 'Kapucinska 29',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.682843, 45.560688 ]
			},
			properties: {
				građevina: 'Zgrada Hrvatske gospodarske komore',
				oznaka: 'Z-2337',
				'Vrijeme nastanka': 'arh. Engelsrath i graditelj Hermann',
				Autori: '1893. god.',
				adresa: 'Europska avenija 13',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.707278, 45.558258 ]
			},
			properties: {
				građevina: 'Zgrada jahaonice bivše topničke vojarne – „Manjež“',
				oznaka: 'Z-7225',
				'Vrijeme nastanka': 'Anton Soukup',
				Autori: '1897. god',
				adresa: 'Cara Hadrijana',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
				'UNESCO zaštita:': 'ne',
				'Opis dobra':
					'Jahaonica topničke vojarne izgrađena je potkraj 1897. g. zajedno s cijelim kompleksom Topničke vojarne koja je izgrađena na prostoru između osječkog Novog i Donjeg grada, jugoistočno do osječke Tvrđe. Jahaonicu je, kao i cijeli kompleks vojarne projektirao inženjer Anton Soukup. Sastoji od dva dijela: većeg koji je jednoprostorna dvorana jahaonice i manjeg u kojemu se nalaze prateći sadržaji. Građevina je to jedinstvene morfologije i očuvanog izvornog konstruktivnog sklopa s modernim konstruktivnim elementima.'
			}
		},
		{
			type: 'Feature',
			geometry: {
				type: 'Point',
				coordinates: [ 18.684287, 45.560858 ]
			},
			properties: {
				građevina: 'Zgrada Korsky',
				oznaka: 'Z-2467',
				'Vrijeme nastanka': 'Ferenc Fischer',
				Autori: '1904. god.',
				adresa: 'Europska avenija 16',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
				'UNESCO zaštita:': 'ne',
				'Opis dobra':
					'Jednokatna dvokrilna - obiteljska «kuća Korsky» nepravilanog je tlocrta. Kuću je projektirao mađarski arhitekt Ferenc Fischer, 1904 godine. Ispred proćelja je predvrt širok 5. m. Predvrt je ograđen željeznom ukrasnom ogradom na niskom parapetu. Ulično pročelje s rizalitima i balkonom detaljirano je secesijskom ornamentikom i plavim pločicama. Arhitektonsko dekorativna koncepcija nadahnuće nalazi u specifičnom nacionalnom tradicijskom nasljeđu, narodnom graditeljstvu i primjenjenoj umjetnosti mađarske.'
			}
		},
		{
			type: 'Feature',
			geometry: {
				type: 'Point',
				coordinates: [ 18.684029, 45.554814 ]
			},
			properties: {
				građevina: 'Zgrada Lucić',
				oznaka: 'Z-3279',
				'Vrijeme nastanka': 'Ante Slaviček, Julijo Löffler',
				Autori: '20. st 1908. god.',
				adresa: 'Reisnerova 59a i 61',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
				'UNESCO zaštita:': 'ne',
				'Opis dobra':
					'Sačuvani su projekti dvaju osječkih projektanata. Ranije datirane projekte potpisuje Julijo Löffler, a potječu iz 1906. Kasnijega datuma su projekti Ante Slavičeka, iz 1908. god. Svi su naslovljeni na istu vlasnicu, Olgu Lucić. Preinake koje u Löfflerov projekt unosi Ante Slaviček tiču se razlika u oblikovanju pročelja i unutrašnjeg rasporeda prostorija. Kuća Lucić je ugrađena katnica visokoga prizemlja, rađena u secesijskom stilu. Raskošno ornamentiranom pročelju odgovara jednako raskošno uređeno unutrašnje stubište, gdje su sačuvane izvorne pločice, kovana ograda stubišta, plitki zidni reljefi helenističkog uzora te dekoracija stropa.'
			}
		},
		{
			type: 'Feature',
			geometry: {
				type: 'Point',
				coordinates: [ 18.69628, 45.560212 ]
			},
			properties: {
				građevina: 'Zgrada magistrata',
				oznaka: 'Z-1259',
				'Vrijeme nastanka': '',
				Autori: '1702. g.',
				adresa: 'Trg sv. Trojstva 6',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
				'UNESCO zaštita:': 'ne',
				'Opis dobra':
					'Zgrada Magistrata, ugaona katnica s tri krila, izgrađena 1702. g., ima stilske karakteristike baroka, nalazi se u središtu osječke Tvrđe. Glavno zapadno pročelje rastvoreno je s pet prozorskih osi. U središnjoj osi u prizemlju nalazi se ulaz lučnog zaključka i trijem. Iznad trijema na katu se nalazi balkon. Zona prizemlja je izvorno bila glatko obrađena. Prizemlje od zone kata odvaja traka razdijelnog vijenca. Prozori kata imaju naglašene prozorske klupčice i barokne profilacije s uškama. Zidni plašt kata obogaćen je u žbuci profiliranim ukladama među prozorima te profiliranom parapetnom zonom i zonom iznad natprozornika. Iznad vrata na balkonu nalazi se kameni grb grada. Danas je u toj zgradi smješten Muzej Slavonije.'
			}
		},
		{
			type: 'Feature',
			geometry: {
				type: 'Point',
				coordinates: [ 18.68255, 45.5578 ]
			},
			properties: {
				građevina: 'Zgrada Maksimović',
				oznaka: 'Z-2327',
				'Vrijeme nastanka': 'Vladimir Nikolić',
				Autori: '1896. god.',
				adresa: 'Radićeva 20',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.678276, 45.561244 ]
			},
			properties: {
				građevina: 'Zgrada Muačević',
				oznaka: 'Z-6271',
				'Vrijeme nastanka': '',
				Autori: '1862. god.',
				adresa: 'Kapucinska 42',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.690488, 45.556726 ]
			},
			properties: {
				građevina: 'Zgrada Muačević',
				oznaka: 'Z-3044',
				'Vrijeme nastanka': 'Viktor Axmann; Vladimir Potočnjak',
				Autori: '1937. god.',
				adresa: 'Keršovanijeva 8',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
				'UNESCO zaštita:': 'ne',
				'Opis dobra':
					'Slobodnostojeća jednokatnica pravokutne tlocrtne osnove smještena je u nizu vila okruženih vrtovima u Keršovanijevoj ulici u Osijeku. Izgrađena je 1937. g. prema projektu arhitekte Vladimira Potočnjaka, a radove su izveli ing. V. Aksmanović (V. Axmann) iz Osijeka i ing. Spiller i Kastl iz Zagreba. Građena je prema narudžbi dr. Branka Muačevića kao obiteljska kuća s ordinacijom. Potpuna funkcionalnost i jednostavnost u projektiranju unutrašnjeg prostora građevine, upadljiva čistoća pročelja kao i izmjenična igra punih i praznih volumena manifestno govore o stilskom opredjeljenju projektanta kuće te je upravo zbog tih svojstava kuća Muačević jedinstveni i vrijedan primjer osječke moderne.'
			}
		},
		{
			type: 'Feature',
			geometry: {
				type: 'Point',
				coordinates: [ 18.683655, 45.560954 ]
			},
			properties: {
				građevina: 'Zgrada Nayer',
				oznaka: 'Z-2341',
				'Vrijeme nastanka': 'W. C. Hofbauer',
				Autori: '1904. god.',
				adresa: 'Europska avenija 20',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.688137, 45.559291 ]
			},
			properties: {
				građevina: 'Zgrada Okružnog ureda za osiguranje radnika',
				oznaka: 'Z-2328',
				'Vrijeme nastanka': 'Bela Auer i Zvonimir Vrkljan',
				Autori: '20. st.',
				adresa: 'Perivoj kralja Petra Krešimira IV 6',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.681585, 45.561744 ]
			},
			properties: {
				građevina: 'Zgrada Pilpel',
				oznaka: 'Z-3389',
				'Vrijeme nastanka': 'Vladimir Šterk',
				Autori: '1932. god.',
				adresa: 'Šetalište P. Preradovića 7',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
				'UNESCO zaštita:': 'ne',
				'Opis dobra':
					'Dvokatna uglovnica smještena projekt je Vladimira Šterka iz 1932. godine. Vlasniku gradilišne parcele ing. Pilpel Vjekoslavu izdana je građevinska dozvola dana 25. svibnja 1932. godine. Gradnju su izvodili građevno poduzeće Dlouhy i Fulla, a nadzor je vršio ing. Mudrovčić Dragoljub. Kuća čini dio značajnog urbarhitektonskog sklopa Preradovićevog šetališta gdje obilježava sam ugao i sudionik je u skladnoj raznolikosti arhitektonskih oblikovanja prve polovice XX. stoljeća. Kuća je projekt uvaženog zagrebačkog arhitekte moderne, školovanog u Pragu koji je projektom za kuću Pilpel svoj doprinos ostavio i arhitektonskoj baštini Osijeka.'
			}
		},
		{
			type: 'Feature',
			geometry: {
				type: 'Point',
				coordinates: [ 18.683299, 45.561039 ]
			},
			properties: {
				građevina: 'Zgrada Povischil',
				oznaka: 'Z-2342',
				'Vrijeme nastanka': 'Ante Slaviček ',
				Autori: '1904. god.',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.672764, 45.562961 ]
			},
			properties: {
				građevina: 'Zgrada procesualnog suda',
				oznaka: 'Z-2325',
				'Vrijeme nastanka': '',
				Autori: '',
				adresa: 'Strossmayerova 33',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
				'UNESCO zaštita:': 'ne',
				'Opis dobra':
					'Ugrađena jednokatna stambena građevina nekadašnja zgrada Procesualnog suda tlocrtno pokazuje zatvorenu formu s manjim traktom prema dvorištu, u kome je drveno stubište za kat i tavan. Kasnobarokna zgrada s uličnim pročeljem rasčlanjenim jednoličnim ritmom dvokrilnih prozorskih otvora s plitko ožbukanim doprozornicima ima bočno smješten kolni ulaz s drvenim dvokrilnim vratima.'
			}
		},
		{
			type: 'Feature',
			geometry: {
				type: 'Point',
				coordinates: [ 18.677614, 45.561436 ]
			},
			properties: {
				građevina: 'Zgrada prve Hrvatske štedionice',
				oznaka: ' Z-3781',
				'Vrijeme nastanka': 'Dioniz Sunko',
				Autori: '1910. god.',
				adresa: 'Trg A. Starčevića 12',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.693733, 45.560518 ]
			},
			properties: {
				građevina: 'Zgrada Raith',
				oznaka: 'Z-1255',
				'Vrijeme nastanka': '',
				Autori: '',
				adresa: 'Kuhačeva 27',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.691157, 45.556024 ]
			},
			properties: {
				građevina: 'Zgrada Rohregger',
				oznaka: 'Z-3388',
				'Vrijeme nastanka': 'Ivan Kloda',
				Autori: '1941. god.',
				adresa: 'Vukovarska 27',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.683995, 45.560913 ]
			},
			properties: {
				građevina: 'Zgrada Sauter',
				oznaka: 'Z-2469',
				'Vrijeme nastanka': 'Ante Slaviček ',
				Autori: '1905. god.',
				adresa: 'Europska avenija 18',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.684796, 45.560738 ]
			},
			properties: {
				građevina: 'Zgrada Schmidt',
				oznaka: 'Z-2339',
				'Vrijeme nastanka': 'Franz Wybiral',
				Autori: '1905. god.',
				adresa: 'Europska avenija 12',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
				'UNESCO zaštita:': 'ne',
				'Opis dobra':
					'Jednokatna poluugrađena najamna kuća izgrađena za veleposjednika Franje Dragutina Schmidta s dvorištem i predvrtom ograđenim ukrasnom ogradom od kovanog željeza na zidanom parapetu odlikuje se rasćlanjenim proćeljem s izvijenim zabatom i atikom. Gradnju je izveo graditelj Franz Wybiral 1905. godine. Kuća ima složenu tlocrtnu dispoziciju. Rasčlanjena struktura neobarokne, neorenesansne i secesijske morfološke dekoracije sintetizira u sebi elemente ukrasne i funkcionalne kvalitete plularizma stilova kao što su mansardni krov, visoka atika, atlanti na proćelju, boćno postavljena altana, cvjetovi suncokreta na ukrasnoj željeznoj ogradi ili stilizirani prikazi ptica u interijeru.\n'
			}
		},
		{
			type: 'Feature',
			geometry: {
				type: 'Point',
				coordinates: [ 18.683326, 45.561795 ]
			},
			properties: {
				građevina: 'Zgrada Schonwald',
				oznaka: 'Z-3099',
				'Vrijeme nastanka': 'Ante Slaviček ',
				Autori: '1904. god.',
				adresa: 'Šetalište kardinala F. Šepera 7',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.685203, 45.560674 ]
			},
			properties: {
				građevina: 'Zgrada Sekulić-Plavšić',
				oznaka: 'Z-2338',
				'Vrijeme nastanka': 'W. C. Hofbauer',
				Autori: '1906. god.',
				...
				'UNESCO zaštita:': 'ne',
				'Opis dobra':
					'Dvokatna uglovnica Sekulić-Plavšić nepravilnog je tlocrta, izgrađena kao najamna kuća s osam stanova i stanom domara u podrumu. Gradnju je izveo graditelj W. C. Hofbauer 1906. g. Tlocrt je prilagođen položaju kuće s dobrim rasporedom unutrašnjih komunikacija sa sobama okrenutim prema ulici, a pomoćnim prostorijama prema dvorištu. Urbanistička dispozicija i arhitektonska koncepcija naglašena je bogatstvom i snagom simboličkih ukrasa, kartuša, girlanda i floralnih ornamenata. Ugaonom markacijom balkona poduprtim neobičnim željeznim konzolama i poligonalnom kupolom s laternom, kuća Sekulić zauzima posebno mjesto u slici grada.\n'
			}
		},
		{
			type: 'Feature',
			geometry: {
				type: 'Point',
				coordinates: [ 18.669737, 45.565088 ]
			},
			properties: {
				građevina: 'Zgrada Solarskog ureda',
				oznaka: 'Z-2586',
				'Vrijeme nastanka': '',
				Autori: '18. st.',
				adresa: 'Solarski trg 1 ref kirsch crkva?',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.684543, 45.560962 ]
			},
			properties: {
				građevina: 'Zgrada Spitzer',
				oznaka: 'Z-2340',
				'Vrijeme nastanka': '',
				Autori: '1905. god',
				adresa: 'Europska avenija 14',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.691394, 45.557487 ]
			},
			properties: {
				građevina: 'Zgrada Vančura',
				oznaka: 'Z-3098',
				'Vrijeme nastanka': 'Viktor Axmann',
				Autori: '1941. god.',
				adresa: 'Keršovanijeva 5',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.718311, 45.559765 ]
			},
			properties: {
				građevina: 'Zgrada vjeroispovjedne škole',
				oznaka: 'Z-3182',
				'Vrijeme nastanka': '',
				Autori: '1782. god.',
				adresa: 'Gojkovićeva 12',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.68405, 45.556539 ]
			},
			properties: {
				građevina: 'Zgrada Woger',
				oznaka: 'Z-3097',
				'Vrijeme nastanka': 'N. Dulihar',
				Autori: '1904. god.',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.687314, 45.557352 ]
			},
			properties: {
				građevina: 'Zgrada Zimmer',
				oznaka: 'Z-3100',
				'Vrijeme nastanka': 'Julije Löffler',
				Autori: '1923. god. do 1925. god.',
				adresa: 'Krežmina 11',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.719689, 45.557286 ]
			},
			properties: {
				građevina: 'Zgrada Živanović',
				oznaka: 'Z-1659',
				'Vrijeme nastanka': '',
				Autori: 'prijelaz 18 na 19 stoljece',
				adresa: 'Krstova 20',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.67718, 45.561037 ]
			},
			properties: {
				građevina: 'Zgrada Županijskog poglavarstva',
				oznaka: 'Z-2334',
				'Vrijeme nastanka': 'Franz Wybiral',
				Autori: '1891. god.',
				adresa: 'Trg A. Starčevića 2',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'profana graditeljska baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.732916, 45.54256 ]
			},
			properties: {
				građevina: 'Židovsko groblje',
				oznaka: 'Z-6547',
				'Vrijeme nastanka': '',
				Autori: '1888. god.',
				adresa: 'Ulica Rastanka',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'memorijalna baština',
		...
		},
		{
			...
			geometry: {
				type: 'Point',
				coordinates: [ 18.66997, 45.550565 ]
			},
			properties: {
				građevina: 'Židovsko groblje',
				oznaka: 'Z-5940',
				'Vrijeme nastanka': '',
				Autori: '1850. god.',
				adresa: 'Ulica Sv. Leopolda Bogdana Mandića 23',
				Mjesto: 'Osijek',
				'pravni status': 'zaštićeno kulturno dobro',
				vrsta: 'nepokretno kulturno dobro - pojedinačno',
				Klasifikacija: 'memorijalna baština',
